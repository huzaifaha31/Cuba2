...
import { Search, Info, Leaf, Filter } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5E6CA] text-manuscript-dark font-sans selection:bg-manuscript-gold selection:text-white">
      ...
      <main className="pt-20">
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-10 justify-center items-center">
              <div className="relative w-full md:w-96">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-full border-2 border-manuscript-gold/30 bg-white/50 focus:bg-white focus:outline-none focus:border-manuscript-gold transition-colors"
                />
              </div>
        ...
        {currentView === 'ABOUT' && (
          <div className="max-w-4xl mx-auto px-4 py-16 animate-fade-in-up">
            <div className="bg-white p-8 md:p-12 rounded-2xl shadow-xl border-t-8 border-manuscript-gold relative overflow-hidden">
              ...
              <div className="space-y-6 text-lg font-serif text-manuscript-brown leading-relaxed">
                ...
                <p>
                  For centuries, traditional healers (known as <em>Bomoh</em> or <em>Dukun</em>) have documented their knowledge in manuscripts written in Jawi script. These texts contain comprehensive guides on treating ailments using locally available herbs, roots, and spiritual practices.
                </p>
                <div className="bg-manuscript-paper/50 p-6 rounded-lg border-l-4 border-manuscript-gold">
                  ...
                  <p>
                    Our mission is to digitize, categorize, and visualize this data, making it accessible for researchers, historians, and anyone interested in the rich heritage of Malay traditional medicine.
                  </p>
                </div>
                <p>
                  Data presented here is sourced from various historical manuscripts including <em>Kitab Tibb</em> and <em>Bustan Salatin</em>.
                </p>
              </div>
            </div>
          </div>
